...
window.KHADIJA_MULTIPLAYER_PATCH = 'm3-release-candidate-readiness-r1';
console.info('[Multiplayer Build] m3-team-final-world-reconnect-r3 | protocol 6');
console.info('[Multiplayer Patch] m3-release-candidate-readiness-r1');
if (new URLSearchParams(window.location.search).get('mpDebug') === '1') {
  console.info('[Multiplayer Debug] Loopback-only · Recovery Lab F8 · Certification F9 · Release Candidate F10');
}
