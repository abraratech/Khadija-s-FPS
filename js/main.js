...
window.KHADIJA_MULTIPLAYER_BUILD = 'm4-cloud-sync-reliability-r1';
window.KHADIJA_MULTIPLAYER_PATCH = 'm4-cloud-sync-reliability-r1';
console.info('[Multiplayer Build] m4-cloud-sync-reliability-r1 | protocol 6');
console.info('[Multiplayer Patch] m4-cloud-sync-reliability-r1');
