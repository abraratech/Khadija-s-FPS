...
const frontendIdentity={protocol:6,build:'m3-team-final-world-reconnect-r3',patch:'m3-production-release-manifest-r1',certifiedBaselineSha:'3d57aab9b75e6b1e04ceeedd5afd5957f3ae361b',releaseStatus:'CERTIFIED'};
const workerIdentity={protocol:6,build:'m3-team-final-world-reconnect-r3',patch:'m3-production-release-manifest-r1',certifiedFrontendSha:'3d57aab9b75e6b1e04ceeedd5afd5957f3ae361b',releaseStatus:'CERTIFIED'};
const worker={...workerIdentity,workerUrl:'https://khadijas-arena-multiplayer.abraratech-8cc.workers.dev'};
...
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://preview.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:true,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks,frontendRelease:frontendIdentity,workerRelease:worker}).ready,false);
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://khadija-s-fps.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:true,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks.map((x,i)=>i?x:{...x,actualSha256:'0'.repeat(64)}),frontendRelease:frontendIdentity,workerRelease:worker}).ready,false);
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://khadija-s-fps.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:false,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks,frontendRelease:frontendIdentity,workerRelease:worker}).ready,false);
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://khadija-s-fps.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:true,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks,frontendRelease:frontendIdentity,workerRelease:{...worker,build:'wrong'}}).ready,false);
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://khadija-s-fps.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:true,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks,frontendRelease:{...frontendIdentity,certifiedBaselineSha:'0'.repeat(40)},workerRelease:worker}).ready,false);
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://khadija-s-fps.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:true,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks,frontendRelease:{...workerIdentity},workerRelease:worker}).ready,true);
assert.equal(evaluateAutomaticPagesDeploymentEvidence({manifest,productionOrigin:'https://khadija-s-fps.pages.dev',submittedCommitSha:'bb2545fad7c7589af25348b4d6f7359e0f9aa8be',githubPushConfirmed:true,automaticDeploymentConfirmed:true,maintenanceManifest:maintenance,artifactChecks:checks,frontendRelease:frontendIdentity,workerRelease:{...worker,certifiedFrontendSha:undefined,certifiedBaselineSha:'3d57aab9b75e6b1e04ceeedd5afd5957f3ae361b'}}).ready,false);
