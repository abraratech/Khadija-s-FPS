...
assert.ok([
  ...
  'gameplay6-r1-world-progression', 'gameplay7-r1-dynamic-campaign-faction-control', 'loadout2-r1-weapon-mastery-operator-specialization-melee', 'quality2-r1-consolidated-low-gpu-rendering', 'endgame1-r1-high-difficulty-operations', 'content2-r1-new-arena-enemy-expansion', 'quality2-r2-consolidated-polish-certification'
