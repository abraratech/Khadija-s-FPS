...
assert.equal(release.releaseId, 'pvp5-r1-competitive-match-completion-stabilization');
assert.equal(release.sourceBaselineSha, '9c57f5ab6516ac8fef0b1e70a0e9e0bf0d53ef87');
