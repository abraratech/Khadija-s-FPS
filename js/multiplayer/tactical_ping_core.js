...
export const TACTICAL_PING_LIFETIMES_MS = Object.freeze({
  ...
  [TACTICAL_PING_TYPES.DEFEND]: 18000,
  [TACTICAL_PING_TYPES.REGROUP]: 12000,
  [TACTICAL_PING_TYPES.INTERACT]: 10000,
  [TACTICAL_PING_TYPES.REVIVE]: 12000
});
...
export const TACTICAL_PING_COLORS = Object.freeze({
  ...
  [TACTICAL_PING_TYPES.DEFEND]: '#7db4ff',
  [TACTICAL_PING_TYPES.REGROUP]: '#59f0c2',
  [TACTICAL_PING_TYPES.INTERACT]: '#c58cff',
  [TACTICAL_PING_TYPES.REVIVE]: '#ff6f9f'
});
...
export const TACTICAL_PING_LABELS = Object.freeze({
  ...
  [TACTICAL_PING_TYPES.INTERACT]: 'INTERACT HERE',
...
export function normalizePingType(value) {
  ...
  const aliases = {
    ...
    REVIVE: TACTICAL_PING_TYPES.REVIVE,
    ...
    DEFEND: TACTICAL_PING_TYPES.DEFEND,
    DEFEND_HERE: TACTICAL_PING_TYPES.DEFEND,
    HOLD: TACTICAL_PING_TYPES.DEFEND,
    HOLD_POSITION: TACTICAL_PING_TYPES.DEFEND,
    REGROUP: TACTICAL_PING_TYPES.REGROUP,
    RALLY: TACTICAL_PING_TYPES.REGROUP,
    INTERACT: TACTICAL_PING_TYPES.INTERACT,
    INTERACT_HERE: TACTICAL_PING_TYPES.INTERACT,
    REVIVE_RESCUE: TACTICAL_PING_TYPES.REVIVE,
    REVIVE_ALLY: TACTICAL_PING_TYPES.REVIVE,
    RESCUE: TACTICAL_PING_TYPES.REVIVE
  };
