...
assert.match(builder, /ROOT_FILES = \("index\.html", "moderation\.html", "favicon\.ico", "multiplayer-release\.json", "release-version\.json", "pvp-production-seal\.json", "_headers"\)/);
