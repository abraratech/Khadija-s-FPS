...
assert.ok(['social2-r1-arena-id-friend-discovery', 'net1-r1-webrtc-hybrid-transport', 'gameplay2-r1-late-round-arena-mutations', 'gameplay3-r1-interactive-evolving-maps', 'gameplay4-r1-expanded-boss-encounters', 'gameplay5-r1-narrative-operations', 'gameplay6-r1-world-progression'].includes(descriptor.releaseId));
assert.ok(['1.1.0-social2-r1', '1.2.0-net1-r1', '1.3.0-gameplay2-r1', '1.4.0-gameplay3-r1', '1.5.0-gameplay4-r1', '1.6.0-gameplay5-r1', '1.7.0-gameplay6-r1'].includes(descriptor.productVersion));
