...
assert.ok(['social2-r1-arena-id-friend-discovery', 'net1-r1-webrtc-hybrid-transport', 'gameplay2-r1-late-round-arena-mutations'].includes(descriptor.releaseId));
assert.ok(['1.1.0-social2-r1', '1.2.0-net1-r1', '1.3.0-gameplay2-r1'].includes(descriptor.productVersion));
